...
global["PlayerKexiafenBal"]=PlayerKexiafenBal;
async function PlayerKexiafenBal(uname) {
    timestamp = time();
...
async function orderQryShagnxiafen(uname) {
    timestamp = time();
...
async function shangfen(uname, score) {
   ...
   require("fp_ati1990")
    ...
    if(rztobj.data.code==0)
    {
        ...
        let file = __dirname+"/../opLogColl.json";
