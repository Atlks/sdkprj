...
function AtiJsBridge13(){
	
	this.method="get";
	}
AtiJsBridge13.prototype.exe=function(param,callback,otherParam)
{
...
//	submit_befor_check();
	...
	//	alert(hre_web_url);
		...
		console.log("--AtiJsBridge13 ajax url:"+urlP2);
		$.ajax(
						{
							type:  this.method,
							url:urlP2,
							...
							success: function(data) {
							  ...
							  }catch(e)
							  {
								...
								//	  alert(data);
								  logx("--AtiJsBridge13 rzt:"+data);//v5
								//  throw e;
							  }
