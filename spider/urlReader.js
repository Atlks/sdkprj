 ...
 */
  ...
  start_dir=__dirname+"/../../reader_url_cfg";
  savemaindir="c:\\000urlreader_rzt_save_compc2"
  //node C:\0workspace\atiplat_eeJS\com.attilax\spider\urlReader.js
...
var  fname=fileUtilAti.fileNameEncode(  link.text )
               ...
               var savepath = savemaindir+"\\"+sub_dir_name + "\\"+fname+"_" + timeUtil.getTimestamp() + '.html';
