...
dataServiceV4.prototype.merge=function(metaData,merge_callback_fun)
  {
	// this.
	  ...
	  mp=mp+"&$method=com.attilax.dataService.DataServiceV2.exe&$callback=page_load_callback&$mod=userMod&$view_store_path=com/attilax/order&$op=merge&"+metaData+"&$fldAppFun="+encodeURIComponent(fldAppFun);
