...
atiOrm.prototype.merge=function(metaData,merge_callback_fun)
  {
	// this.
	       if(!metaData)
			...
			this.objtype="table";
	  mp=mp+"&$tb=@tb@&$tbtype=@tbtype@&$method=com.attilax.orm.AtiOrm.exe&$callback=page_load_callback&$mod=userMod&$view_store_path=com/attilax/order&$op=merge&"+metaData+"&$fldAppFun="+encodeURIComponent(fldAppFun);
