...
//atiOrmV3.prototype
atiOrmV3.prototype.t= function(data)
{
	alert(this.merge_after_goto_url);
}
atiOrmV3.prototype.insert_callback= function(data)
{
//	 jo=str2json(data);
	   logx(data);
//--------------------------------ex 	   
...
atiOrmV3.prototype.default_callback= function(data)
{
 jo=str2json(data);
	   logx(data);
//--------------------------------ex 	   
...
atiOrmV3.prototype.merge_callback= function(data)
{
	 jo=str2json(data);
	   logx(data);
...
atiOrmV3.prototype.merge=function(metaData,merge_callback_fun)
  {
	// this.
	       if(!metaData)
	      		 	metaData="";
			...
			this.objtype="table";
	  mp=mp+"&$tb=@tb@&$tbtype=@tbtype@&$method=com.attilax.orm.atiOrmV3.exe&$callback=page_load_callback&$mod=userMod&$view_store_path=com/attilax/order&$op=merge&"+metaData+"&$fldAppFun="+encodeURIComponent(fldAppFun);
  ...
  atiOrmV3.prototype.save=function(metaData,callback_fun)
  {
  	this.insert(metaData,callback_fun);
  }
  atiOrmV3.prototype.insert=function(metaData,callback_fun)
  {
	  this.objtype="table";
    ...
    atiOrmV3.prototype.update=function(metaData,callback_fun)
  {
   ...
   atiOrmV3.prototype.del=function(metaData,callback_fun)
  {
...
atiOrmV3.prototype.query=function(metaData,merge_callback_fun)
  {
	 
	          	var mp=$("form").serialize();
			var fldAppFun=dslUtil.getFldAppFun(  mp);
		 var code="new(com.attilax.orm.AtiOrm).query($sql$)";
