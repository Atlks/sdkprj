...
class target(db_check):
    ...
    def add(self, name, level=None, location_code=None, link=None, index_order=None, status=None):
        ...
        return self.DB_connection.insert(self._table_name, 'table_target_id_seq', _parent_self=self, name=name, level=level, location_code=location_code, link=link, index_order=index_order, status=status)
