...
class target_synced(db_check):
    ...
    _table_name='table_target_synced'
    ...
    def add(self, source_id, target_id, item_id, result_id, status=None, created=None, result_link=None):
        ...
        return self.DB_connection.insert(self._table_name, 'table_target_synced_id_seq', _parent_self=self, source_id=source_id, target_id=target_id, item_id=item_id, result_id=result_id, status=status, created=created, result_link=result_link)
    ...
    def set(self, id=None, condition_source_id=None, condition_target_id=None, condition_item_id=None, condition_result_id=None, operation="", source_id=None, target_id=None, item_id=None, result_id=None, status=None, created=None, result_link=None,  _condition=""):
        if isinstance(condition_target_id, (tuple, list)):
            ret_loop_result = []
            for loop_item_id in condition_target_id:
                ret_loop_result.append(self.set(row=row, condition_target_id=loop_item_id, operation=operation, article_id=article_id, audit_status=audit_status, _condition=_condition))
